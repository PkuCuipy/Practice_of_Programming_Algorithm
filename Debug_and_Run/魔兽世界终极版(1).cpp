...
class wolf:public warrior
{
    public:
        ...
        virtual void rob_weapon(warrior *enemy)
        {
            if(wq[0]==nullptr&&enemy->wq[0]!=nullptr)
            {
                wq[0]=enemy->wq[0];
                enemy->wq[0]=nullptr;
            ...
            if(wq[1]==nullptr&&enemy->wq[1]!=nullptr)
            {
                wq[1]=enemy->wq[1];
                enemy->wq[1]=nullptr;
            }
            if(wq[2]==nullptr&&enemy->wq[2]!=nullptr)
            {
                wq[2]=enemy->wq[2];
                enemy->wq[2]=nullptr;
            }
...
{
    public:
        warrior *RedWarrier=nullptr;
        warrior *BlueWarrier=nullptr;
        warrior *extraRedWarrier=nullptr;
        warrior *extraBlueWarrier=nullptr;
        int flag=0;
        int last_winner=0;
        int life_point=0;
};
int fight(warrior *red,warrior *blue,battlefield *city,int city_id)
{
    ...
    if(red->life>0&&blue->life>0)
    {
        if(city->flag==1||(city->flag==0&&city_id%2==1))
        {
            ...
            if(red->wq[0]!=nullptr&&red->wq[0]->available==false)
            {
                delete red->wq[0];
                red->wq[0]=nullptr;
            }
            if(blue->life>0)
            {
                ...
                blue->fight_back(red);
                if(blue->wq[0]!=nullptr&&blue->wq[0]->available==false)
                {
                    delete blue->wq[0];
                    blue->wq[0]=nullptr;
                }
        ...
        while(60*hour+minute<=T)
        {
            if(war)
            {
                ...
                else if(minute==5)
                {
                    if(field[0]->RedWarrier!=nullptr)
                    {
                        if(field[0]->RedWarrier->name=="lion"&&field[0]->RedWarrier->loyalty<=0)
                        {
                            ...
                            delete field[0]->RedWarrier;
                            field[0]->RedWarrier=nullptr;
                        }
                    }
                    for(int i=1;i<=N;i++)
                    {
                        if(field[i]->RedWarrier!=nullptr)
                        {
                            if(field[i]->RedWarrier->name=="lion"&&field[i]->RedWarrier->loyalty<=0)
                            {
                                ...
                                delete field[i]->RedWarrier;
                                field[i]->RedWarrier=nullptr;
                            }
                        }
                        if(field[i]->BlueWarrier!=nullptr)
                        {
                            if(field[i]->BlueWarrier->name=="lion"&&field[i]->BlueWarrier->loyalty<=0)
                            {
                                ...
                                delete field[i]->BlueWarrier;
                                field[i]->BlueWarrier=nullptr;
                            }
                        }
                    }
                    if(field[N+1]->BlueWarrier!=nullptr)
                    {
                        if(field[N+1]->BlueWarrier->name=="lion"&&field[N+1]->BlueWarrier->loyalty<=0)
                        {
                            ...
                            delete field[N+1]->BlueWarrier;
                            field[N+1]->BlueWarrier=nullptr;
                        }
                    }
                    minute=10;
                }
                else if(minute==10)
                {
                    ...
                    if(field[0]->extraBlueWarrier!=nullptr)
                    {
                    ...
                    if(field[N+1]->RedWarrier!=nullptr)
                    {
                        ...
                        else if(field[N+1]->extraRedWarrier!=nullptr)
                        {
                ...
                else if(minute==30)
                {
                    for(int i=1;i<=N;++i)
                    {
                        if(field[i]->RedWarrier!=nullptr&&field[i]->BlueWarrier==nullptr)
                        {
                        ...
                        else if(field[i]->RedWarrier==nullptr&&field[i]->BlueWarrier!=nullptr)
                        {
                ...
                {
                    if(field[0]->RedWarrier!=nullptr&&field[1]->BlueWarrier!=nullptr)
                    {
                        if(field[0]->RedWarrier->wq[2]!=nullptr)
                        {
                            field[0]->RedWarrier->wq[2]->attack(0,field[1]->BlueWarrier->life,field[0]->RedWarrier->life);
                            if(!field[0]->RedWarrier->wq[2]->available)
                            { 
                                delete field[0]->RedWarrier->wq[2];
                                field[0]->RedWarrier->wq[2]=nullptr;
                            }
                    ...
                    for(int i=1;i<=N;i++)
                    {
                        if(field[i]->RedWarrier!=nullptr&&field[i+1]->BlueWarrier!=nullptr)
                        {
                            if(field[i]->RedWarrier->wq[2]!=nullptr)
                            {
                                field[i]->RedWarrier->wq[2]->attack(0,field[i+1]->BlueWarrier->life,field[i]->RedWarrier->life);
                                if(!field[i]->RedWarrier->wq[2]->available)
                                {
                                    delete field[i]->RedWarrier->wq[2];
                                    field[i]->RedWarrier->wq[2]=nullptr;
                                }
                        ...
                        if(field[i]->BlueWarrier!=nullptr&&field[i-1]->RedWarrier!=nullptr)
                        {
                            if(field[i]->BlueWarrier->wq[2]!=nullptr)
                            {
                                ...
                                {
                                    delete field[i]->BlueWarrier->wq[2];
                                    field[i]->BlueWarrier->wq[2]=nullptr;
                                }
                    ...
                    if(field[N+1]->BlueWarrier!=nullptr&&field[N]->RedWarrier!=nullptr)
                        {
                            if(field[N+1]->BlueWarrier->wq[2]!=nullptr)
                            {
                                ...
                                {
                                    delete field[N+1]->BlueWarrier->wq[2];
                                    field[N+1]->BlueWarrier->wq[2]=nullptr;
                                }
                    ...
                    for(int i=1;i<=N;++i)
                    {
                        if(field[i]->BlueWarrier!=nullptr&&field[i]->RedWarrier==nullptr&&field[i]->BlueWarrier->life<=0)
                        {
                            delete field[i]->BlueWarrier;
                            field[i]->BlueWarrier=nullptr;
                        }
                        else if(field[i]->RedWarrier!=nullptr&&field[i]->BlueWarrier==nullptr&&field[i]->RedWarrier->life<=0)
                        {
                            delete field[i]->RedWarrier;
                            field[i]->RedWarrier=nullptr;
                        }
                ...
                else if(minute==38)
                {
                    for(int i=1;i<=N;++i)
                    {
                        if(field[i]->RedWarrier!=nullptr&&field[i]->BlueWarrier!=nullptr&&field[i]->RedWarrier->life>0&&field[i]->BlueWarrier->life>0)
                        {
                            if(field[i]->RedWarrier->wq[1]!=nullptr||field[i]->BlueWarrier->wq[1]!=nullptr)
                            {
                                ...
                                if(field[i]->flag==1||(field[i]->flag==0&&i%2==1))
                                {
                                    ...
                                    if(field[i]->RedWarrier->wq[0]!=nullptr)
                                    ...
                                    if(temp_blue>0&&field[i]->BlueWarrier->name!="ninja")
                                    {
                                        ...
                                        if(field[i]->BlueWarrier->wq[0]!=nullptr)
                                ...
                                if(temp_blue<=0&&field[i]->BlueWarrier->wq[1]!=nullptr)
                                {
                                ...
                                else if(temp_red<=0&&field[i]->RedWarrier->wq[1]!=nullptr)
                                {
